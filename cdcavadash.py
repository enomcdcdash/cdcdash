...
with st.sidebar:
    st.markdown("<h2 style='text-align: center;'>📊 Dashboard CDC</h2>", unsafe_allow_html=True)
...
# --- Main Content: Monthly Availability ---
    ...
    st.markdown("<h3 style='text-align: center; color: gray;'>🚧 This page is under development 🚧</h3>", unsafe_allow_html=True)
